  ...
  return <>
    <section className="relative h-[calc(100svh-5rem)] min-h-[590px] max-h-[820px] overflow-hidden">
      <div className="absolute inset-0">
        {[prophet, heroStudy, yaba2].map((src, index) => <img key={src} src={src} alt="" className="hero-slide absolute inset-0 h-full w-full object-cover" width={1920} height={1088} fetchPriority={index === 0 ? "high" : "auto"} />)}
      </div>
      ...
      <div className="site-container relative z-10 flex h-full flex-col justify-end pb-12 md:pb-16">
        ...
        <h1 className="max-w-5xl font-display text-5xl leading-[1.03] text-sand md:text-7xl lg:text-[5.6rem]">Rooted in the Word,<br/><em className="font-normal text-gold">community</em>, and discipleship.</h1>
