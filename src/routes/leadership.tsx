...
import heroLeadership from "../assets/hero_leadership.jpeg";
...
function LeadershipPage() {
  return <ContentPage heroImage={heroLeadership} eyebrow="Leadership" title="Serving the Church and the next generation." intro="Meet the approved leadership profiles currently available for Gospel Pillars International and Nigeria 2 Division.">
